...
import com.allandroidprojects.ecomsample.cache.CircleTransform;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageViewIcon = headerView.findViewById(R.id.imageView);

        String urlString = "https://cdn-images-1.medium.com/fit/c/200/200/1*PcOdKrCpJH7MY5nbVevpPg.jpeg";
        // hardcoded Image setup for Demo
        Picasso.get().load(urlString)
                .resize(100, 100)
                .centerCrop()
                .transform(new CircleTransform())
                .placeholder(R.drawable.ic_lens_black_24dp)
                .into(imageViewIcon);
